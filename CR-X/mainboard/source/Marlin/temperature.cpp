...
//			Running = false;
//			killed = true;
//			kill(lcd_msg);	// Diabale lcd message display
		}
		else
		{
			disable_all_heaters(); // paranoia prohibits all heating.
		}
	#endif
}
...
void Temperature::isr() {
  ...
  #if ENABLED(ENDSTOP_INTERRUPTS_FEATURE)	// 0
